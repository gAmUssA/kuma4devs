...
class DefaultHeadersConfig {
     ...
     */
    fun header(name: String, value: String): Unit = headers.append(name, value)

    /**
     * Provides a time source. Useful for testing.
     */
    var clock: Clock = Clock { System.now().toEpochMilliseconds() }
 ...
 */
val DefaultHeaders: RouteScopedPlugin<DefaultHeadersConfig> = createRouteScopedPlugin(
    "DefaultHeaders",
